...
<script type="application/ld+json">
{
  ...
  "@type": "BreadcrumbList",
  "itemListElement": [
    { "@type": "ListItem", "position": 1, "name": "Home", "item": "https://www.chandraprakash.tech/" },
    { "@type": "ListItem", "position": 2, "name": "Writing", "item": "https://www.chandraprakash.tech/blog/" },
    { "@type": "ListItem", "position": 3, "name": ${JSON.stringify(article.title)}, "item": ${JSON.stringify(url)} }
  ]
}
</script>
</head>
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    { "@type": "ListItem", "position": 1, "name": "Home", "item": "https://www.chandraprakash.tech/" },
    { "@type": "ListItem", "position": 2, "name": "Selected Work", "item": "https://www.chandraprakash.tech/#work" },
    { "@type": "ListItem", "position": 3, "name": ${JSON.stringify(item.title)}, "item": ${JSON.stringify(url)} }
  ]
}
</script>
</head>
